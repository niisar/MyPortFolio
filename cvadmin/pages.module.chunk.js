...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-xxxl-3 col-md-6\" *ngFor=\"let r of groups\" (click)=\"trainGroup(r)\">\r\n    <ngx-status-card title=\"{{r.name}}\" type=\"primary\" [on]=\"r.training\">\r\n      <i class=\"nb-lightbulb\"></i>\r\n    </ngx-status-card>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\">\r\n  <div class=\"col-xl-12\">\r\n    <ngx-security-cameras></ngx-security-cameras>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\">\r\n  <div class=\"col-xxxl-9 col-xxl-12 col-md-7\">\r\n    <ngx-rooms></ngx-rooms>\r\n  </div>\r\n\r\n  <div class=\"col-xxxl-3 col-xxl-4 col-md-5\">\r\n    <ngx-contacts></ngx-contacts>\r\n  </div>\r\n</div>\r\n"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.getGroupList = function () {
        var _this = this;
        this.service.getGroup().subscribe(function (data) {
            _this.groups = data;
            _this.groups.forEach(function (x) { x.training = false; });
        });
    };
    DashboardComponent.prototype.trainGroup = function (group) {
        group.training = true;
        this.service.trainGroup(group.personGroupId).subscribe(function (data) {
            setTimeout(function () {
    ...
    function RoomSelectorComponent() {
        ...
        this.roomSvg = {
            ...
            rooms: [
                {
                    id: '0',
                    name: { text: 'Organic', x: 142, y: 240.8 },
...
var StatusCardComponent = /** @class */ (function () {
    ...
    StatusCardComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: "\n    <nb-card (click)=\"on = !on\" [ngClass]=\"{'off': !on}\">\n      <div class=\"icon-container\">\n        <div class=\"icon {{ type }}\">\n          <ng-content></ng-content>\n        </div>\n      </div>\n\n      <div class=\"details\">\n        <div class=\"title\">{{ title }}</div>\n        <div class=\"status\">{{ on ? 'Training Started' : 'Start Training' }}</div>\n      </div>\n    </nb-card>\n  ",
        })
    ], StatusCardComponent);
...
var MENU_ITEMS = [
    ...
    },
    {
        ...
        children: [
            {
                title: 'Group',
                link: '/pages/manage/group-list',
            },
            {
                title: 'Person',
                link: '/pages/manage/person-list',
            },
        ],
    },
    {
        ...
        children: [
            {
                title: 'Verify',
                link: '/pages/verification/verify-face',
            },
        ],
    },
    {
...
// import { PagesComponent } from './manage-person/manage-person.module';
var routes = [{
        path: '',
        ...
        children: [{
                ...
                path: 'manage',
                loadChildren: './manage-person/manage-person.module#ManagePersonModule',
            }, {
                path: 'verification',
