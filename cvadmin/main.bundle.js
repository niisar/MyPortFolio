...
var map = {
	...
	"./manage-person/manage-person.module": [
		"../../../../../src/app/pages/manage-person/manage-person.module.ts",
		"common",
		"manage-person.module"
	],
	"./maps/maps.module": [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__group_service__ = __webpack_require__("../../../../../src/app/@core/data/group.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__person_service__ = __webpack_require__("../../../../../src/app/@core/data/person.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__face_service__ = __webpack_require__("../../../../../src/app/@core/data/face.service.ts");
...
var SERVICES = [
    ...
    __WEBPACK_IMPORTED_MODULE_6__group_service__["a" /* GroupService */],
    __WEBPACK_IMPORTED_MODULE_7__person_service__["a" /* PersonService */],
    __WEBPACK_IMPORTED_MODULE_8__face_service__["a" /* FaceService */],
];
...
/***/ "../../../../../src/app/@core/data/face.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var FaceService = /** @class */ (function () {
    ...
    FaceService.prototype.detect = function (blob) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/octet-stream',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
            }),
        };
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/detect";
        return this.http.post(endpoint, blob, httpOptions);
    };
    FaceService.prototype.identify = function (personGroupId, faceIds) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
        ...
        var body = {
            ...
            faceIds: faceIds,
            maxNumOfCandidatesReturned: __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.maxNumOfCandidatesReturned,
            confidenceThreshold: __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.confidenceThreshold,
        };
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/identify";
        return this.http.post(endpoint, body, httpOptions);
    };
    FaceService.prototype.verify = function (personGroupId, personId, faceIds) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/verify";
        return this.http.post(endpoint, body, httpOptions);
    };
...
/***/ "../../../../../src/app/@core/data/group.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var GroupService = /** @class */ (function () {
    ...
    GroupService.prototype.getGroup = function () {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups", httpOptions);
    };
    GroupService.prototype.saveGroup = function (bodyParam) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var body = {
            name: bodyParam.name,
            userData: bodyParam.userData,
        };
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + bodyParam.personGroupId;
        return this.http.put(endpoint, body, httpOptions);
    };
    GroupService.prototype.trainGroup = function (personGroupId) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + personGroupId + "/train";
        return this.http.post(endpoint, {}, httpOptions);
    };
    GroupService.prototype.updateData = function (bodyParam) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + bodyParam.personGroupId;
        return this.http.patch(endpoint, body, httpOptions);
    };
    GroupService.prototype.deleteGroup = function (bodyParam) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
...
var PersonService = /** @class */ (function () {
    ...
    PersonService.prototype.getPersonList = function (groupName) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + groupName + "/persons";
        return this.http.get(endpoint, httpOptions);
    };
    PersonService.prototype.createPersonFace = function (bodyParam, blob) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/octet-stream',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + bodyParam.personGroupId + "/persons/" + bodyParam.personId + "/persistedFaces";
        return this.http.post(endpoint, blob, httpOptions);
    };
    PersonService.prototype.createPerson = function (bodyParam) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + bodyParam.personGroupId + "/persons";
        return this.http.post(endpoint, body, httpOptions);
    };
    PersonService.prototype.updatePerson = function (bodyParam) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
        ...
        var endpoint = __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.endpoint + "/persongroups/" + bodyParam.personGroupId + "/persons/" + bodyParam.personId;
        return this.http.patch(endpoint, body, httpOptions);
    };
    PersonService.prototype.deletePerson = function (bodyParam) {
        var httpOptions = {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Ocp-Apim-Subscription-Key': __WEBPACK_IMPORTED_MODULE_2__assets_appsettings_json__["default"].api.face.key,
...
module.exports = {"default":{"enableToggleLayout":false,"enableTheamSwitcher":false,"app":{"firstName":"Vision","lastName":"Admin1","title":"Vision Admin"},"proprietor":{"name":"  ","social":[{"name":"facebook","icon":"ion ion-social-facebook","hidden":true,"link":"#"},{"name":"facebook","icon":"ion ion-social-twitter","hidden":true,"link":"#"},{"name":"linkedin","icon":"ion ion-social-linkedin","hidden":true,"link":"#"}]},"api":{"vision":{"key":"eb796219d53646d28a6d7392e2849fb5","endpoint":"https://eastasia.api.cognitive.microsoft.com/vision/v1.0"},"face":{"key":"65ed162a3c174a6aba4e0d67b8e69b39","endpoint":"https://westus.api.cognitive.microsoft.com/face/v1.0","maxNumOfCandidatesReturned":1,"confidenceThreshold":0.5},"emotion":{"key":"efd827be03eb49b2b100c365f099e3e6","endpoint":"https://westus.api.cognitive.microsoft.com/emotion/v1.0"},"native":{"endpoint":"http://localhost:4300/api"}}}}
