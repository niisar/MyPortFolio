...
var NbEmailPassAuthProvider = /** @class */ (function (_super) {
    ...
    function NbEmailPassAuthProvider(http, route) {
        ...
        _this.route = route;
        _this.defaultConfig = {
            baseEndpoint: 'https://node-admin-jwt.herokuapp.com',
            login: {
                alwaysFail: false,
                rememberMe: true,
                endpoint: '/api/auth/login',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__quiz_service__ = __webpack_require__("../../../../../src/app/@core/data/quiz.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__helper_service__ = __webpack_require__("../../../../../src/app/@core/data/helper.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SERVICES = [
    ...
    __WEBPACK_IMPORTED_MODULE_8__quiz_service__["a" /* QuizService */],
    __WEBPACK_IMPORTED_MODULE_9__helper_service__["a" /* HelperService */],
];
...
/***/ "../../../../../src/app/@core/data/helper.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/@core/data/quiz.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pipes__ = __webpack_require__("../../../../../src/app/@theme/pipes/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__layouts__ = __webpack_require__("../../../../../src/app/@theme/layouts/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__styles_theme_default__ = __webpack_require__("../../../../../src/app/@theme/styles/theme.default.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__styles_theme_cosmic__ = __webpack_require__("../../../../../src/app/@theme/styles/theme.cosmic.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NB_MODULES = [
    ...
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["m" /* NbTabsetModule */],
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["i" /* NbRouteTabsetModule */],
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["g" /* NbMenuModule */],
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["p" /* NbUserModule */],
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["a" /* NbActionsModule */],
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["j" /* NbSearchModule */],
    __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["k" /* NbSidebarModule */],
...
var COMPONENTS = [
    __WEBPACK_IMPORTED_MODULE_7__components__["e" /* ThemeSwitcherComponent */],
    __WEBPACK_IMPORTED_MODULE_7__components__["b" /* HeaderComponent */],
    __WEBPACK_IMPORTED_MODULE_7__components__["a" /* FooterComponent */],
    __WEBPACK_IMPORTED_MODULE_7__components__["c" /* SearchInputComponent */],
    __WEBPACK_IMPORTED_MODULE_7__components__["d" /* ThemeSettingsComponent */],
    __WEBPACK_IMPORTED_MODULE_7__components__["f" /* TinyMCEComponent */],
    __WEBPACK_IMPORTED_MODULE_9__layouts__["a" /* OneColumnLayoutComponent */],
    __WEBPACK_IMPORTED_MODULE_9__layouts__["b" /* SampleLayoutComponent */],
    __WEBPACK_IMPORTED_MODULE_9__layouts__["c" /* ThreeColumnsLayoutComponent */],
    __WEBPACK_IMPORTED_MODULE_9__layouts__["d" /* TwoColumnsLayoutComponent */],
];
var PIPES = [
    __WEBPACK_IMPORTED_MODULE_8__pipes__["a" /* CapitalizePipe */],
    __WEBPACK_IMPORTED_MODULE_8__pipes__["b" /* PluralPipe */],
    __WEBPACK_IMPORTED_MODULE_8__pipes__["c" /* RoundPipe */],
    __WEBPACK_IMPORTED_MODULE_8__pipes__["d" /* TimingPipe */],
];
var NB_THEME_PROVIDERS = __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["n" /* NbThemeModule */].forRoot({
    name: 'default',
}, [__WEBPACK_IMPORTED_MODULE_10__styles_theme_default__["a" /* DEFAULT_THEME */], __WEBPACK_IMPORTED_MODULE_11__styles_theme_cosmic__["a" /* COSMIC_THEME */]]).providers.concat(__WEBPACK_IMPORTED_MODULE_6__nebular_theme__["k" /* NbSidebarModule */].forRoot().providers, __WEBPACK_IMPORTED_MODULE_6__nebular_theme__["g" /* NbMenuModule */].forRoot().providers, [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_auth__ = __webpack_require__("../../../../../src/app/@auth/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'auth',
        component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["a" /* NbAuthComponent */],
        children: [
            {
                path: '',
                component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["d" /* NbLoginComponent */],
            },
            {
                path: 'login',
                component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["d" /* NbLoginComponent */],
            ...
            {
                path: 'register',
                component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["f" /* NbRegisterComponent */],
            },
            {
                path: 'logout',
                component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["e" /* NbLogoutComponent */],
            },
            {
                path: 'request-password',
                component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["g" /* NbRequestPasswordComponent */],
            },
            {
                path: 'reset-password',
                component: __WEBPACK_IMPORTED_MODULE_3__app_auth__["h" /* NbResetPasswordComponent */],
            },
        ],
    },
    { path: 'pages', loadChildren: 'app/pages/pages.module#PagesModule', canActivate: [__WEBPACK_IMPORTED_MODULE_2__app_routing_guard__["a" /* AppRoutingGuard */]], },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ngx_pipes__ = __webpack_require__("../../../../ngx-pipes/ngx-pipes.es5.js");
/**
 * @license
 * Copyright Akveo. All Rights Reserved.
 * Licensed under the MIT License. See License.txt in the project root for license information.
...
module.exports = {"default":{"enableToggleLayout":false,"enableTheamSwitcher":true,"app":{"firstName":"Dashboard","lastName":"Auth","title":"Auth Dashboard"},"proprietor":{"name":"niisar","social":[{"name":"facebook","icon":"ion ion-social-facebook","hidden":false,"link":"#"},{"name":"twitter","icon":"ion ion-social-twitter","hidden":false,"link":"#"},{"name":"linkedin","icon":"ion ion-social-linkedin","hidden":false,"link":"#"}]},"api":{"native":{"endpoint":"https://node-admin-jwt.herokuapp.com/api","authendpoint":"https://node-admin-jwt.herokuapp.com/auth"}}}}
