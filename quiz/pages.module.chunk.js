...
var ContactsComponent = /** @class */ (function () {
    ...
    ContactsComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getUsers()
            ...
            _this.contacts = users.data.reverse().slice(0, 8);
            _this.recent = users.data.reverse().slice(0, 8);
        });
    };
